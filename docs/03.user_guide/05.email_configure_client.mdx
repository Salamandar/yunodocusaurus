...
##### <SmallInline url='/img/grav/thunderbird.png'/> Configure Mozilla Thunderbird (on a desktop computer)
...
![](/img/grav/thunderbird_config_1.png)
![](/img/grav/thunderbird_config_2.png)
...
##### <SmallInline url='/img/grav/k9mail.png'/> Configure K-9 Mail (on Android)

Follow the following steps. (As for Thunderbird, you might need to accept certificates at some points)

![](/img/grav/k9mail_config_1.png)
![](/img/grav/k9mail_config_2.png)
![](/img/grav/k9mail_config_3.png)
![](/img/grav/k9mail_config_4.png)


</TabItem>
<TabItem value="dekko" label="Dekko">

##### <SmallInline url='/img/grav/dekko-app.png'/> Configure Dekko (on Ubuntu Touch)
...
![](/img/grav/dekko_config_1.png)
![](/img/grav/dekko_config_2.png)
![](/img/grav/dekko_config_3.png)
![](/img/grav/dekko_config_4.png)
