...
![User panel screenshot](/img/grav/user_panel.png)
...
<Figure caption="From the main menu of the webadmin, open `Users`." alt="Main menu" src="/img/grav/create_user_1.png"/>
<Figure caption="From the top of the users list, click on `+ New user`." alt="Users list" src="/img/grav/create_user_2.png"/>
<Figure caption="Fill in the form." alt="User creation form" src="/img/grav/create_user_3.png"/>
