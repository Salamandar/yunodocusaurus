...
<Figure alt="Apps list" caption="Apps list in the webadmin, with its Install button." src="/img/grav/apps_list.png"/>
...
<LinkButton url="https://apps.yunohost.org" color="orange"><icon icon='fa-cubes'/> Applications Catalog</LinkButton>
</div>
...
<Tabs groupId="admin-commands">
  <TabItem value="web" label="From the web interface">
    <Figure alt="Custom Webapp install form" src="/img/grav/app_install_form.png" caption="Pre-installation form of the Custom Webapp"/>
  </TabItem>
  <TabItem value="cli" label="From the command line">
    <Figure alt="Custom Webapp install form in CLI" src="/img/grav/app_install_form_cli.png" caption="Pre-installation form of the Custom Webapp in CLI"/>
  </TabItem>
</Tabs>
...
<Figure alt="Application operations page" src="/img/grav/app_config_operations.png" caption="Application operations page in the webadmin"/>
...
The configuration panels are accessible in the webadmin in their operations page, trough the <Highlight no_break={true} color='darkblue'><icon icon="fa-cogs"/> Config panel</Highlight> button.

<Figure alt="My Webapp configuration panel" src="/img/grav/app_config_panel.png" caption="Configuration panel for My Webapp"/>
