...
OVH gives one IPv4 address and one IPv6 address for VPS but by default, only IPv4 is enabled.

The documentation for OVH is here : <https://docs.ovh.com/gb/en/vps/configuring-ipv6/>

### Configure the DNS server

Here : [DNS subdomains](/dns_subdomains)
