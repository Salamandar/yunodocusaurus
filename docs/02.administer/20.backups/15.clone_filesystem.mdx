...
<TabItem value="virtualbox" label="VirtualBox">
  ...
  ![The snapshot button is located at the top right](/img/grav/administrate/specific_use_cases/virtualbox-snapshot2.webp)

  To restore, select the virtual machine, click on `Snapshots` then `Restore Snapshot option`.
  ![](/img/grav/administrate/specific_use_cases/virtualbox-snapshot3.webp)

  Then click on `Restore Snapshot`.
  ![](/img/grav/administrate/specific_use_cases/virtualbox-snapshot4.webp)
