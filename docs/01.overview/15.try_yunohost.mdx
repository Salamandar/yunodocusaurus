...
<YunoHostDocsCard>
  ...
  <icon icon='fa-user'/> User interface
...
<YunoHostDocsCard>
  ...
  <icon icon='fa-cog'/> Administration interface
...
:::info
**Demo server gracefully provided by [Gitoyen](https://www.gitoyen.net?target=_blank) <icon icon="fa-heart" style={{color: "green"}}/>**
:::
